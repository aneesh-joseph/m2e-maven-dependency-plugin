package com.coderplus.apacheutils.translators;
...
public class ClassifierTypeTranslator
{
    ...
    public Set<Artifact> translate( Set<Artifact> artifacts)
    {
        ...
        for ( Artifact artifact : artifacts )
        {
            ...
            Artifact newArtifact = new DefaultArtifact( artifact.getGroupId(), artifact.getArtifactId(), artifact.getVersion(),Artifact.SCOPE_COMPILE , useType, useClassifier,new DefaultArtifactHandler(useType));
